...
import com.idealizer.review_x.application.modules.actors.validators.ActorValidator;
...
public class UpdateActorService {
    ...
    public UpdateActorService(ActorRepository actorRepository, ActorValidator actorValidator) {
