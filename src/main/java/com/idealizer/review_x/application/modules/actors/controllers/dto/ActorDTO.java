package com.idealizer.review_x.application.modules.actors.controllers.dto;
...
public record ActorDTO(ObjectId id,
                ...
                String avatarUrl,
                String description,
                @NotBlank @Size(min = 3, max = 50) String nationality, Instant createdAt, Instant updatedAt) {
}
